...
void DrawPlaylistBox(Font poppinsFontBold) {
    ...
    Vector2 headingPos = { 1457.0f, 132.0f };
    ...
    DrawTextEx(poppinsFontBold, "English", label1Pos, 30.0f * FONT_SCALE, 1.0f, WHITE);
    ...
    DrawTextEx(poppinsFontBold, "Hindi", label2Pos, 30.0f * FONT_SCALE, 1.0f, WHITE);
    ...
    DrawTextEx(poppinsFontBold, "Nepali", label3Pos, 30.0f * FONT_SCALE, 1.0f, WHITE);
    ...
    DrawTextEx(poppinsFontBold, "Spanish", label4Pos, 30.0f * FONT_SCALE, 1.0f, WHITE);
}
